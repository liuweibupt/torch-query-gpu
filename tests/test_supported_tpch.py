...
from tpch_torch.runner import validate_sql, validate_sql_with_plan_source
...
def test_all_tpch_queries_validate_through_auto_plan_source(tpch_con, query_id):
    sql = get_tpch_query(tpch_con, query_id)

    result = validate_sql_with_plan_source(tpch_con, sql, device="cpu", plan_source="auto")
