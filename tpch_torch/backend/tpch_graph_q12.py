"""TPC-H Q12 graph-query execution on PyTorch tensors."""
...
from tpch_torch.backend.graph_nodes import aggregate_sum_by_keys, decode, fetch_tensor_table, lookup_values, string_in


def execute_q12_graph(con: duckdb.DuckDBPyConnection, device: str = "cpu") -> list[dict[str, Any]]:
