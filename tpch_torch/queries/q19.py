"""TPC-H Q19 execution on PyTorch tensors."""
...
from tpch_torch.relational import fetch_tensor_table, lookup_values, string_eq, string_in


def execute_q19(con: duckdb.DuckDBPyConnection, device: str = "cpu") -> list[dict[str, Any]]:
