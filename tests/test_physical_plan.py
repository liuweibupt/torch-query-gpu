...
def test_q1_fused_physical_plan_aggregates_with_masked_bincount_without_payload_gather(monkeypatch):
    ...
    def fail_payload_gather(*_args, **_kwargs):
        raise AssertionError("Q1 fused aggregation should avoid selected-row payload gathers")

    monkeypatch.setattr("tpch_torch.backend.physical_fusion._gather_q1_columns", fail_payload_gather)
